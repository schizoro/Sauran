...
**Normal, aktif DM'ler için bu değişiklikle yeni bir saklama süresi tanımlanmamıştır.** Lobi mesajları, karşı tarafın diğer DM'leri ve
...
| Veri | Ne olur |
|---|---|
| Silinen hesabın mesajları, ekleri, kullanıcı adı, gönderen bağlantıları | **Hemen silinir.** Karşı tarafın sohbetinde konuşmanın sırası bozulmasın diye içeriksiz bir "mezar taşı" satırı kalır (içerik, ek, ad ve gönderen bağlantısı yok; yalnızca zaman damgası ve alıcı). |
...
- **Karşı taraf da hesabını silerse** sohbet (mesajlar + mezar taşları) hemen tamamen silinir.
